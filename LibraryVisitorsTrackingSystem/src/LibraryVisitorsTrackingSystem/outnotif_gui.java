...
//          notify_name.setText(Login_Gui.nameNotify);
    ...
    private void initComponents() {
        ...
        jPanel1.add(notify_time, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, -1, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, -1, -1));

        notify_name1.setFont(new java.awt.Font("Courier New", 1, 24)); // NOI18N
        notify_name1.setForeground(new java.awt.Color(204, 0, 0));
        notify_name1.setText("Successfully Logout");
        jPanel1.add(notify_name1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(outnotif_gui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
